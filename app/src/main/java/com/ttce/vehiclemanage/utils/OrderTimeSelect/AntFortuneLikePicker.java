...
public class AntFortuneLikePicker extends LinkagePicker {
    ...
    public AntFortuneLikePicker(@NonNull Activity activity,String strtype) {
    ...
    protected void initData() {
        ...
        titleView.setText(strtype);
        titleView.setTextSize(16);
        wheelLayout.setTextSize(15 * contentView.getResources().getDisplayMetrics().density);
        wheelLayout.setSelectedTextSize(15 * contentView.getResources().getDisplayMetrics().density);
