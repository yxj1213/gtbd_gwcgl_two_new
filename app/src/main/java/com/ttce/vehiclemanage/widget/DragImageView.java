...
public class DragImageView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
     ...
     * @param block 滑块
     */
    public void setUp(Bitmap cover, Bitmap block,String top) {
        this.cover = cover;
        this.block = block;
        ...
        layoutParams2.setMargins(0, DeviceUtils.dip2px(getContext(),Integer.valueOf(top)), 0, 0);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (dragListenner != null) {
            dragListenner.onDrag(DisplayUtil.px2dip(getContext(), (drag_iv_cover.getMeasuredWidth() - drag_iv_block.getMeasuredWidth()) * 1f * seekBar.getProgress() / seekBar.getMax()
            ));
        }
