package com.ttce.vehiclemanage.widget.TabLayout;/*
...
//        if (bottomLineMode == 1) {
        int bottomLineColor = a.getColor(R.styleable.TabLayout_bottomLineColor, getResources().getColor(R.color.white));
...
//        }
        ...
        mTabStrip.setDividerColor(a.getColor(R.styleable.TabLayout_dividerColor,getResources().getColor(R.color.white)));
