package com.ttce.vehiclemanage.widget.SeekBar;
...
import static com.ttce.vehiclemanage.widget.SeekBar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.ttce.vehiclemanage.widget.SeekBar.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    public static float minProgress, maxProgress;
    ...
    private float changeBeforeSeekBarProgress=0f;
    @Override
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                //changeBeforeSeekBarProgress=leftSB.getProgress()+1;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                changeThumbActivateState(true);
               // EventBus.getDefault().post(new MessageEvent(AppConstant.PROGRESS,leftSB.getProgress(),changeBeforeSeekBarProgress));
                break;
            ...
            case MotionEvent.ACTION_UP:
                ...
                changeThumbActivateState(false);
                EventBus.getDefault().post(new MessageEvent(AppConstant.PROGRESS,position));
                break;
        }
    ...
    public SeekBarState[] getRangeSeekBarState() {
        ...
        position= (int) leftSB.getProgress();

//        if(position<LocusActivity.gjPointList.size()){
//            leftSB.setIndicatorTextStringFormat(LocusActivity.gjPointList.get(position).getGpsTimeFormat());
//        }
