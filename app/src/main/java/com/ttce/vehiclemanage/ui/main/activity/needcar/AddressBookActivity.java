 ...
 * 已修改
 * */
public class AddressBookActivity extends BaseActivity implements RailManageContract.View,OnRefreshListener, OnLoadMoreListener,AddressBookAdapter.AddressBookListenter {
    ...
    public void initView() {
        ...
        tv_sure.setText(getResources().getString(R.string.address_book_txt4));
        titleBarTitle.setText(getResources().getString(R.string.ditu7));
        irc.setLayoutManager(new LinearLayoutManager(this));


        datas.clear();
        datas.add(new TuJingDiBean("兰亭御湖城","山西省太原市晋源区义井街道",null,"","",""));
        addressBookAdapter = new AddressBookAdapter(AddressBookActivity.this,R.layout.address_book_item, datas, this,"地址簿");
    ...
    public void editAddressBook(TuJingDiBean item) {
        DiTuCheckAddressActivity.goToPage(this,mtag,new Gson().toJson(item),"添加地址簿");
        finish();
    }
