...
import static com.ttce.vehiclemanage.ui.main.activity.needcar.MapPlaceChooseActivity.mtag;

public class PoiItemAdapter extends RecyclerView.Adapter {
    private List<PoiInfo> mPoiInfos; // poi信息
    private int mCurSelectPos = 1; // 当前选中的item pos
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        myViewHolder.mPoiItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int pos = myViewHolder.getAdapterPosition()-2;
        ...
        myViewHolder.mImgCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int pos = myViewHolder.getAdapterPosition()-2;
                if (null != mPoiInfos && pos < mPoiInfos.size()) {
                    PoiInfo poiInfo = mPoiInfos.get(pos);
                    mOnItemClickListener.onImgCheckClick(poiInfo);
                }
            }
        });
    ...
    private void bindPoiInfo(MyViewHolder viewHolder, int position) {
        ...
        viewHolder.mImgCheck.setText("设为"+mtag);
        ...
        if (!TextUtils.isEmpty(poiAddress)) {
            if (View.INVISIBLE == viewHolder.mPoiAddressText.getVisibility()
                ...
                layoutParams.setMargins(DisplayUtil.dip2px(0), DisplayUtil.dip2px(40), DisplayUtil.dip2px(0),DisplayUtil.dip2px( 0));
    ...
    public interface MyOnItemClickListener {
        ...
        void onImgCheckClick(PoiInfo poiInfo);
    }
