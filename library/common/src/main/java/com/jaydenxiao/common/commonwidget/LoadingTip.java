...
public class LoadingTip extends LinearLayout {
    ...
    public static enum LoadStatus {
        sereverError, error, empty, loading, finish,haveDate
    }
    ...
    public void setLoadingTip(LoadStatus loadStatus) {
        switch (loadStatus) {
            ...
            case empty:
                ...
                img_tip_logo.setImageResource(R.drawable.icon_no_data);
                break;
            case sereverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
            ...
            case finish:
                setVisibility(View.GONE);
                img_tip_logo.setImageResource(R.drawable.ic_success);
                break;
        }
    }
