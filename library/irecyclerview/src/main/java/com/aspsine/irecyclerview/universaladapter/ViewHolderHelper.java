...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setFlowText(int viewId, String text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        ViewGroup.LayoutParams lp = tv.getLayoutParams();
        if (lp instanceof FlexboxLayoutManager.LayoutParams) {
            FlexboxLayoutManager.LayoutParams flexboxLp =
                    (FlexboxLayoutManager.LayoutParams) tv.getLayoutParams();
    ...
    public ViewHolderHelper setAdapter(int viewId, CommonRecycleViewAdapter adapter, RecyclerView.LayoutManager layoutManager) {
        IRecyclerView view = (IRecyclerView) getView(viewId);
    ...
    public ViewHolderHelper setOnCheckChangeListener(int viewId,
